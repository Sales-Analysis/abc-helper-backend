...
const (
	...
	ErrMissingResult      ErrCode = "MISSING_RESULT"
	ErrMissingJobID       ErrCode = "MISSING_JOB_ID"
	ErrJobNotFound        ErrCode = "EXPLANATION_JOB_NOT_FOUND"
	ErrUploadFileNotFound ErrCode = "UPLOAD_FILE_NOT_FOUND"
	ErrInvalidExt         ErrCode = "INVALID_EXTENSION"
	ErrReadError          ErrCode = "READ_ERROR"
	ErrInvalidXLSX        ErrCode = "INVALID_XLSX"
	ErrAssistantFailed    ErrCode = "ASSISTANT_EXPLANATION_FAILED"
	ErrUploadPrepFailed   ErrCode = "ASSISTANT_UPLOAD_PREPARATION_FAILED"
